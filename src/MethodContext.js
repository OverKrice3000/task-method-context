...
export const obj = {
    ...
    actualIncrementor: undefined,
    subscribe() {
        if (!this.actualIncrementor)
            this.actualIncrementor = this.incrementor.bind(this);
        EventEmitter.on('click', this.actualIncrementor);
    },
    unsubscribe() {
        EventEmitter.off('click', this.actualIncrementor);
    },
};
